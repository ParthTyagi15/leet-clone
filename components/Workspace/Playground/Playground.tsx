...
const Playground: React.FC<PlaygroundProps> = ({
  ...
  const pid = pathName.split("/problems/")[1];
  // console.log(pid);
  const handleSubmit = async () => {
    ...
    try {
      ...
      const handler = eval(problems[pid].handlerFunction as unknown as string);
    ...
    <div className="flex flex-col bg-dark-layer-1 relative overflow-x-hidden">
      ...
      >
        ...
        <div className="w-full px-5 overflow-auto">
          ...
          <div className="my-4">
            <p className="text-sm font-semibold mt-4 text-white">Input :</p>
            <div className="w-full cursor-text rounded-lg border px-3 py-[10px] bg-dark-fill-3 border-transparent text-white mt-2">
              {problem.examples[activeTestCaseId].inputText}
            </div>
            <p className="text-sm font-semibold mt-4 text-white">Output :</p>
            <div className="w-full cursor-text rounded-lg border px-3 py-[10px] bg-dark-fill-3 border-transparent text-white mt-2">
